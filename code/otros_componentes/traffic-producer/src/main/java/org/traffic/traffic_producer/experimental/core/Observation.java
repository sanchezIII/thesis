...
public class Observation {
  ...
  public Observation(String streamId, ObservationData data, String resultTimeString) {
    this(streamId, data, LocalDateTime.parse(resultTimeString, DATE_TIME_FORMATTER));
  }

  public Observation(String streamId, ObservationData data, LocalDateTime resultTime) {
  ...
  public static Observation fromJson(JsonObject json, ObservationDataFactory factory) {
  ...
  public static JsonObject asJson(Observation observation, ObservationDataFactory factory) {
